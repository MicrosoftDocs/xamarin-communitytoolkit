...
You can see an example of buttons in action in the [Intune documentation](https://learn.microsoft.com/intune/get-started/choose-how-to-enroll-devices).
...
You can see an example of selectors in action in the [Intune documentation](https://learn.microsoft.com/intune/deploy-use/what-to-tell-your-end-users-about-using-microsoft-intune#how-your-end-users-get-their-apps).
...
You can see an example of step-by-steps in action in the [Advanced Threat Analytics documentation](https://learn.microsoft.com/advanced-threat-analytics/deploy-use/install-ata-step2).
